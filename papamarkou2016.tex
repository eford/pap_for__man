...
\begin{figure}[t]
	\centering
	\subfloat[Running mean]{\includegraphics[width=2.8in]{logit_meanplot.pdf}} 
	\subfloat[Linear autocorrelation]{\includegraphics[width=2.8in]{logit_acfplot.pdf}} \\
	\subfloat[MALA traceplot]{\includegraphics[width=2.8in]{logit_mala_traceplot.pdf}} 
	\subfloat[SMMALA traceplot]{\includegraphics[width=2.8in]{logit_smmala_traceplot.pdf}} \\
	\subfloat[AMSMMALA traceplot]{\includegraphics[width=2.8in]{logit_amsmmala_traceplot.pdf}}
	\subfloat[ALSMMALA traceplot]{\includegraphics[width=2.8in]{logit_alsmmala_traceplot.pdf}} \\
	\caption{
...
Figure \ref{fig:logit} visualizes four chains corresponding to the regression coefficient of covariate 
$\boldsymbol{\theta}_{(2)}$, with a single chain simulated from each of MALA, SMMALA, AMSMMALA and ALSMMALA samplers using 
the Bayesian logistic regression log-target on the Swiss banknotes data. All four overlaid running means, plotted as a 
function of the number of iterations, demonstrate that the respective samplers converge towards the same value. The overlaid 
linear autocorrelations exhibit magnitudes that agree with the effective sample sizes of Table \ref{tab:logit}. More 
specifically, ALSMMALA has the smallest linear autocorrelation and highest ESS by far, followed by SMMALA, while AMSMMALA 
and MALA have roughly the same linear autocorrelation and ESS. All four traceplots of MALA, SMMALA and of the two algorithms 
of this paper exhibit strong mixing properties.
...
\begin{figure}
	\centering
	\subfloat[Running mean]{\includegraphics[width=2.8in]{poisson_meanplot.pdf}} 
	\subfloat[Linear ACF]{\includegraphics[width=2.8in]{poisson_acfplot.pdf}} \\
	\subfloat[MALA traceplot]{\includegraphics[width=2.8in]{poisson_mala_traceplot.pdf}} 
	\subfloat[SMMALA traceplot]{\includegraphics[width=2.8in]{poisson_smmala_traceplot.pdf}} \\
	\subfloat[AMSMMALA traceplot]{\includegraphics[width=2.8in]{poisson_amsmmala_traceplot.pdf}}
	\subfloat[ALSMMALA traceplot]{\includegraphics[width=2.8in]{poisson_alsmmala_traceplot.pdf}} \\ 
