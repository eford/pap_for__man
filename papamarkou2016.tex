...
taking their means over the initial finer $5$ by $5$ meter grid. Figure X visualizes the tree locations and the coarsed 
predictors. Consequently, the processed data consist of the response variable $\mathbf{y}$ holding the number of trees
in each of the $n_d=200$ coarse grid cells as well as the altitude and slop per coarse grid cell. The Poisson regression 
model comprises $n_{\theta}=4$ covariates, namely an intercept, the altitude and its square, and the elevational gradient.
