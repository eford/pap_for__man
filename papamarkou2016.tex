...
Monte Carlo samples are drawn from the class of $n_{\theta}$-dimensional Student-t targets
$t_{\nu}(\mathbf{0},\frac{\nu-2}{\nu}\Sigma)$
...
\end{array}\right),
\end{equation}
for some constant $0<a<1$. So the elements of the $i$-th diagonal of
the $n_{\theta}\times n_{\theta}$ covariance matrix $\Sigma$ are equal to
$a^{i-1},~i=1,2,\dots,n_{\theta}$. It is worth noticing that the scale matrix
$\frac{\nu-2}{\nu}\Sigma$ of the t-distribution is defined by factorizing 
$\Sigma$ by $(\nu-2)/\nu$ so that the covariance matrix of the t-distribution
is $\Sigma$.
