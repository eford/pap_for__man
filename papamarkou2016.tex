...
regression log-target outlined in the current section. The bank dataset contains the measurements of four covariates on 
$n_d=200$ Swiss banknotes, $100$ of which are genuine and $100$ counterfeit. The $n_{\theta}=4$ covariates include the 
